...
def prepare_keys(folder_path, suffix="png"):
    ...
    keys = [
        img_path.split(".{}".format(suffix))[0]
...
def create_lmdb_for_statelite():
    folder_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/Noisy/test"
    lmdb_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/Noisy/test/Noisy_test.lmdb"

    img_path_list, keys = prepare_keys(folder_path, "png")
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/GTruth/test"
    lmdb_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/GTruth/test/GTruth_test.lmdb"

    img_path_list, keys = prepare_keys(folder_path, "png")
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/Noisy/train"
    lmdb_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/Noisy/train/Noisy_train.lmdb"

    img_path_list, keys = prepare_keys(folder_path, "png")
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/GTruth/train"
    lmdb_path = "/home/arthemis/Documents/pytorch_env/pytorch_env/Dataset/SAVE_DATA/AUMENTED/GTruth/train/GTruth_train.lmdb"
